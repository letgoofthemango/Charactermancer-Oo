...
class RangedWeapon extends InventoryItem {
    constructor(name, type, copper, silver, gold, simple, martial, range, damageType, light, heavy, twoHanded, ammunition, loading, special, finesse, damage, description) {
        super(name, type, copper, silver, gold, description),
            this.damage = damage
    }
}
...
class MeleeWeapon extends InventoryItem {
    constructor(name, type, copper, silver, gold, simple, martial, reach, thrown, range, light, heavy, finesse, twoHanded, versatile, versatileDamage, ammunition, loading, special, damage, damageType, description) {
        super(name, type, copper, silver, gold, description),
            this.damage = damage
    }
}
...
class Armor extends InventoryItem {
    constructor(name, type, copper, silver, gold, description, strengthReq, stealthDis, armorClass) {
        super(name, type, copper, silver, gold, description),
...
let navigator = new Tool(ToolName.NAVIGATOR, ItemType.KIT, 0, 0, 25, 3, "This set of instruments is used for navigation at sea. Proficiency with navigator's tools lets you chart a ship's course and follow navigation charts. In addition, these tools allow you to add your proficiency bonus to any ability check you make to avoid getting lost at sea. Proficiency with navigator's tools helps you determine a true course based on observing the stars. It also grants you insight into charts and maps while developing your sense of direction. Components: Navigator's tools include a sextant, a compass, calipers, a ruler, parchment, ink, and a quill.");
...
let vehicles = new Tool(ToolName.VEHICLES, ItemType.ARTISAN, 0, 0, 0, 0, "You know how to operate certain land or water vehicles.");
...
let woodworker = new Tool(ToolName.WOODCARVER, ItemType.ARTISAN, 0, 0, 1, 5, "Woodcarver's tools allow you to craft intricate objects from wood, such as wooden tokens or arrows. Components: Woodcarver's tools consist of a knife, a gouge, and a small saw.")
